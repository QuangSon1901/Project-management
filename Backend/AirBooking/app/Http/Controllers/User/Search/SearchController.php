...
class SearchController extends Controller
{
    public function search(SearchFlightRequest $request) {
        ...
        $flights = Flight::select('tbl_flight.flight_id', 'tbl_airline.airline_name', 'tbl_airplane.airplane_name', 'tbl_airplane.airplane_number',
        'tbl_flight.flight_time_departure', 'tbl_flight.flight_time_fly', 'tbl_airline.airline_logo')
        ...
        ->whereDate('tbl_flight.flight_time_departure', date('Y-m-d',strtotime($request->dateFromInput)))
        ->get();
