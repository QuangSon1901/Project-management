...
<head>
    ...
    <link rel="stylesheet" href="{{asset('user_asset/assets/css/style.css?8812')}}">
    <link rel="stylesheet" href="{{asset('user_asset/assets/css/base.css?1223')}}">
    <link rel="shortcut icon" href="{{asset('user_asset/assets/img/logo-icon.png')}}">
