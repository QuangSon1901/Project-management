<nav class="sidebar sidebar-offcanvas" id="sidebar">
  <ul class="nav">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#statistic" aria-expanded="false" aria-controls="statistic">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#account" aria-expanded="false" aria-controls="account">
        <i class="icon-layout menu-icon"></i>
        <span class="menu-title">Quản lý tài khoản</span>
        <i class="menu-arrow"></i>
      </a>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#system" aria-expanded="false" aria-controls="system">
        <i class="icon-layout menu-icon"></i>
        <span class="menu-title">Quản lý hệ thống</span>
        <i class="menu-arrow"></i>
      </a>
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="collapse" href="#setting" aria-expanded="false" aria-controls="setting">
        <i class="icon-layout menu-icon"></i>
        <span class="menu-title">Cài đặt hệ thống</span>
        <i class="menu-arrow"></i>
      </a>
