<div class="content_filter">
    ...
    <div class="filter_brand-airline">
        ...
        <ul class="filter_brand-list">
            <?php $__currentLoopData = $airlineList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="filter_brand-item">
                <label class="option-checkbox">
                    <input type="checkbox" id="search_checkbox" value="<?php echo e($item->airline_id); ?>" class="filterCheckbox">
                    <i class="icon-checkbox"></i>
                    <img src="<?php echo e(URL::to('upload/'.$item->airline_logo)); ?>" alt="">
                    <?php echo e($item->airline_name); ?>
    ...
    <div class="filter_rank-ticket">
        ...
        <ul class="filter_rank-list">
            <?php $__currentLoopData = $ticketClass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="filter_rank-item">
                <label class="option-checkbox">
                    <input type="checkbox" id="search_checkbox" value="<?php echo e($item->ticket_class_id); ?>" class="filterCheckbox">
                    <i class="icon-checkbox"></i>
                    <img src="" alt="">
                    <?php echo e($item->ticket_class_name); ?>
...
</script><?php /**PATH C:\Users\Son\Desktop\Project-management\Backend\AirBooking\resources\views/user_page/search/search_filter.blade.php ENDPATH**/ ?>