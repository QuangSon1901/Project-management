...
<?php $__env->startSection('search_body'); ?>

<ul class="ticket_body-list">
    <?php $__currentLoopData = $ticketList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if(count($row['ticket']) > 0): ?>
    <li class="ticket_body-item">
        <div class="ticket_info">
            <div class="ticket_info-name">
                <img src="<?php echo e(URL::to('upload/'.$row['flight']->airline_logo)); ?>" alt="">
                <div class="ticket_info-brand-airline">
                    <h4 class="ticket_info-brand-name"><?php echo e($row['flight']->airline_name); ?></h4>
                    <h4 class="ticket_info-brand-id"><?php echo e($row['flight']->airplane_name); ?>/ <?php echo e($row['flight']->airplane_number); ?></h4>
                </div>
            </div>
            <div class="ticket_info-time-dep">
                <div class="ticket_info-time-start">
                    <h4><?php echo e(date('H:i', strtotime($row['flight']->flight_time_departure))); ?></h4>
                    <h4 class="ticket_info-place"><?php echo e($row['aliasFrom']->airport_alias); ?></h4>
                </div>
                ...
                <div class="ticket_info-time-end">
                    <h4><?php echo e(date('H:i', $row['timeArr'])); ?></h4>
                    <h4 class="ticket_info-place"><?php echo e($row['aliasTo']->airport_alias); ?></h4>
                </div>
            </div>
            <div class="ticket_info-time-fly">
                <h4><?php if(date('H', strtotime($row['flight']->flight_time_fly)) != 0): ?>
                    <?php echo e(date('H', strtotime($row['flight']->flight_time_fly))); ?>h
                    <?php endif; ?>
                    <?php echo e(date('i', strtotime($row['flight']->flight_time_fly))); ?>'
                </h4>
        ...
        <div class="ticket_class-seat">
            <ul class="class_seat-list">
                <?php $__currentLoopData = $row['ticket']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="class_seat-item">
                    <form action="/checkout" method="get">
                        <div class="class_seat-body">
                            <div class="class_seat-name">
                                <h4><?php echo e($item['ticket_class_name']); ?></h4>
                            ...
                            <div class="class_seat-order">
                                <div class="class_seat-price">
                                    <h5 class="class_seat-cost"><?php echo e(number_format($item['ticket_price'])); ?>đ</h5>
                                    <h4 class="class_seat-sale"><?php echo e(number_format($item['ticket_price'])); ?>đ</h4>
                                </div>
                                <input type="hidden" name="ticket_id" value="<?php echo e($item['ticket_id']); ?>">
                                <button type="submit" class="btn--primary">Chọn</button>
                            </div>
                        </div>
                                ...
                                <div class="class_seat-desc-info-body">
                                    <div class="seat_desc-info-time">
                                        <div class="seat_desc-info-time-start">
                                            ...
                                            <h4 class="seat_desc-info-time-date">
                                                <?php echo e(date('d-m-Y', strtotime($row['flight']->flight_time_departure))); ?>

                                            </h4>
                                        </div>
                                        <div class="seat_desc-info-time-dep">
                                            <?php if(date('H', strtotime($row['flight']->flight_time_fly)) != 0): ?>
                                            <?php echo e(date('H', strtotime($row['flight']->flight_time_fly))); ?>h
                                            <?php endif; ?>
                                            <?php echo e(date('i', strtotime($row['flight']->flight_time_fly))); ?>'
                                        </div>
                                        <div class="seat_desc-info-time-end">
                                            <h4><?php echo e(date('H:i', $row['timeArr'])); ?></h4>
                                            <h4 class="seat_desc-info-time-date">
                                                <?php echo e(date('d-m-Y', $row['timeArr'])); ?>
                                    ...
                                    <div class="seat_desc-info-place">
                                        <div class="seat_desc-info-place-start">
                                            <h4><?php echo e($row['nameFrom']); ?></h4>
                                            <h4 class="seat_desc-info-place-airplane">
                                                <?php echo e($row['aliasFrom']->airport_name); ?>

                                            </h4>
                                        </div>
                                        <div class="seat_desc-info-place-brandfly">
                                            <img alt="" src="<?php echo e(URL::to('upload/'.$row['flight']->airline_logo)); ?>">
                                            <div class="seat_desc-info-place-brandfly-air">
                                                <div class="seat_desc-info-place-brandfly-air-name">
                                                    <?php echo e($row['flight']->airline_name); ?>

                                                </div>
                                                <div class="seat_desc-info-place-brandfly-air-id">
                                                    <?php echo e($row['flight']->airplane_name); ?> . <?php echo e($row['flight']->airplane_number); ?>
                                        ...
                                        <div class="seat_desc-info-place-end">
                                            <h4><?php echo e($row['nameTo']); ?></h4>
                                            <h4 class="seat_desc-info-place-airplane">
                                                <?php echo e($row['aliasTo']->airport_name); ?>
                            ...
                            <div class="class_seat-desc-info-column">
                                ...
                                <div class="class_seat-desc-info-body body_2">
                                    ...
                                    <div class="class_seat-desc-info-body-price">
                                        <h4><?php echo e(number_format($item['ticket_price'])); ?>đ</h4>
                                        <h4>0đ</h4>
                                        <h4>0đ</h4>
                                        <h4 style="font-weight: 500;"><?php echo e(number_format($item['ticket_price'])); ?>đ</h4>
                                    </div>
                                </div>
...
<?php echo $__env->make('user_page.search.search_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Son\Desktop\Project-management\Backend\AirBooking\resources\views/user_page/search/search_body.blade.php ENDPATH**/ ?>