        ...
        <div class="navbar">
            ...
            <div class="navbar__select">
                <ul class="navbar__category" style="flex: 1; justify-content:center">
                    <li style="pointer-events: none;" id="checkoutInfo" class="navbar__category-item navbar__step-item--active">
                        <a href="#" class="navbar__category-link">
                            <span class="checkout-step-icon">1</span>
                            Thông tin hành khách
                        </a>
                    </li>
                    <li style="pointer-events: none;" id="checkoutPayment" class="navbar__category-item">
                        <a href="#" class="navbar__category-link">
                ...
                <ul class="navbar__category">
                    ...
                    <li class="navbar__category-item navbar__category-info">
                        <div class="navbar__category-link navbar__category-info-link">
                            <img src="<?php echo e(URL::to('upload/'.auth()->user()->avatar)); ?>" class="navbar__category-info-img" alt="">
...
</header><?php /**PATH C:\Users\Son\Desktop\Project-management\Backend\AirBooking\resources\views/user_page/checkout/checkout_navbar.blade.php ENDPATH**/ ?>